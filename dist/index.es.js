...
var OrbitaContext = createContext({
    endpoint: '',
});
...
var OrbitaTextInput = /** @class */ (function (_super) {
    ...
    OrbitaTextInput.prototype.render = function () {
        ...
        return (React.createElement("input", { type: "text", className: this.props.className, value: text, onChange: this.handleChange, onKeyDown: this.handleKeyDown }));
    };
    OrbitaTextInput.contextType = OrbitaContext;
    return OrbitaTextInput;
}(Component));

export { OrbitaProvider, OrbitaTextInput };
